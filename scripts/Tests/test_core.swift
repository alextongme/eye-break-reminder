...
struct TestRunner {
    ...
    static func runPreferencesTests() {
        ...
        check(prefs.promptSound == "Sosumi",      "promptSound default is Sosumi")
        check(prefs.completeSound == "Blow",     "completeSound default is Blow")
        ...
        check(prefs.fullscreenOverlay == true,   "fullscreenOverlay default is true")
